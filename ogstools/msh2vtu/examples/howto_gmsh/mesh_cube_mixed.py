...
top_surface_id=3   # in direction [0,0,1] extrude 2 layers of height 0.5, recombination=True
newEntities=gmsh.model.geo.extrude([(dim2, 5)], 0, -1, 0, [2], [1], True)   # second unit cube
