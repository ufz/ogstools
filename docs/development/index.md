...
## Developing ogstools and another project simultaneously

If you work on ogstools and another project using it at the same time, install ogstools into the other project's venv with:
