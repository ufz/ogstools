...
# Bokeh docstrings use Bokeh's own custom roles (e.g. :bokeh-tree:), not
# registered here; stub them out to avoid "Unknown interpreted text role".
_bokeh_stub_roles = [
    "bokeh-commit",
    "bokeh-issue",
    "bokeh-minpy",
...
def setup(app):
    ...
    for role_name in _bokeh_stub_roles:
        app.add_role(role_name, roles.GenericRole(role_name, nodes.literal))
