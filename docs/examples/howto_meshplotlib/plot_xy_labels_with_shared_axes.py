...
diff_ab, mesh_property = difference(temperature, mesh_a, mesh_b)
plot(diff_ab, mesh_property, fig=fig, ax=ax[0][1])
diff_ba, mesh_property = difference(temperature, mesh_b, mesh_a)
plot(diff_ba, mesh_property, fig=fig, ax=ax[1][1])
fig.tight_layout()
...
plot(mesh_a, temperature, fig=fig, ax=ax[0][0])
plot(mesh_b, temperature, fig=fig, ax=ax[1][0])
plot(*difference(mesh_a, mesh_b, temperature), fig=fig, ax=ax[0][1])
plot(*difference(mesh_b, mesh_a, temperature), fig=fig, ax=ax[1][1])
clear_labels(ax)
