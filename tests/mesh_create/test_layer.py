...
class TestLayer:
    ...
    def test_plane_surfaces(self):
        ...
        planes = [
            create.Surface(
                create.Gaussian2D(
                    (9200, 18800, 9000, 21000), 0, 200, height, 20
                ),
                material_id=id,
            )
